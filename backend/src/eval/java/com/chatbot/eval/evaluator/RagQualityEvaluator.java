...
/**
 * E6 RagQualityEvaluator: evaluates FAQ retrieval pipeline quality.
 * Three sub-metrics:
 * 1. Context Precision: how many retrieved docs are relevant
 * 2. Context Recall: how many expected docs were retrieved
 * 3. Faithfulness: is the reply grounded in retrieved context
 *
 * Only active for episodes with expectedContexts; skips others.
 */
