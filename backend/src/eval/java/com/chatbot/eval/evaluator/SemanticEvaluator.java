...
/**
 * E5 SemanticEvaluator: evaluates reply quality via three optional sub-checks:
 * 1. Golden reply embedding similarity (DashScope)
 * 2. LLM-as-Judge structured scoring (Kimi, separate model variant)
 * 3. Tool argument validation (exact/contains matching)
 */
